...
if(gProfPatrolActive[playerid][prof])
{
    ...
    {
        // Garante que o Actor exista e esteja no mesmo VW/Interior do profissional que aceitou
        if(gProfCalls[callIdx][pcActorId] == -1 || gProfCalls[callIdx][pcActorId] == INVALID_ACTOR_ID)
        {
            ...
            else
            {
                ...
                SetActorInterior(actorid, GetPlayerInterior(playerid));
            }
        ...
        else
        {
            ...
            SetActorInterior(gProfCalls[callIdx][pcActorId], GetPlayerInterior(playerid));
        }
